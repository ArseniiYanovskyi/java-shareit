...
@Service
public class ItemRequestClient extends ru.practicum.shareit.client.BaseClient {
    ...
    public ResponseEntity<Object> getOtherUsersRequestsPagination(long userId, Integer from, Integer size) {
